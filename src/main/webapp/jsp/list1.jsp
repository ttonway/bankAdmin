...
<div class="popup" data-pop="detail">
    ...
    <div class="pop-cont">
        <div class="pop-list">
            ...
            <div class="list-item">
                <span class="list-item-span1">工作单位：</span>
                <span class="list-item-span2" id="workunit3"></span>
            </div>
            <div class="list-item">
                <span class="list-item-span1">申请人数：</span>
                <span class="list-item-span2" id="loanmen3"></span>
            </div>
            <div class="list-item">
                <span class="list-item-span1">个人职务：</span>
                <span class="list-item-span2" id="job3"></span>
            </div>
            <div class="list-item">
                <span class="list-item-span1">月收入：</span>
                <span class="list-item-span2" id="income3"></span>
            </div>
            <div class="list-item">
                <span class="list-item-span1">房贷月供：</span>
                <span class="list-item-span2" id="loanHouse3"></span>
            </div>
            <div class="list-item">
                <span class="list-item-span1">车贷月供：</span>
                <span class="list-item-span2" id="loanCar3"></span>
            </div>
            <div class="list-item">
                <span class="list-item-span1">其他贷款：</span>
                <span class="list-item-span2" id="loanConsumer3"></span>
            </div>
            <div class="list-item">
